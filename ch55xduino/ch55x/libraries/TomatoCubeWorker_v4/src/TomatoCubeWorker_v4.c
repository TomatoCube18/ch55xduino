...
void pixelLED(unsigned char ledPattern) {
      ...
      EA = 0;    
      //17,16,15, 33,32,31,30
      P1 = (P1 & 0x1F) | ((ledPattern & 0x70) << 1);
      P3 = (P3 & 0xF0) | (ledPattern & 0x0F);
      if (interruptOn) EA = 1;      
}
...
//      //17,16,15, 33,32,31,30
//      P1 = (P1 & 0x3D);
////      if ((ledPattern & 0x10) >> 3) P1 |= 0x02; 
//      P1 |= ((ledPattern & 0x60) << 1);
//      P3 = (P3 & 0xF0) | (ledPattern & 0x0F);
//      if (interruptOn) EA = 1;
//      digitalWrite(LED_5_PINOUT, (ledPattern & 0x10)? HIGH:LOW);
//      
//}
