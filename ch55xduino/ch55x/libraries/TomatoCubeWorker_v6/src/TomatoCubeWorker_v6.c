...
void initTomatoCube() {
  ...
  TouchKey_SetMaxHalfDelta(40);      //increase if sensor value are more noisy
  ...
  TouchKey_SetTouchThreshold(1500);  //Bigger touch pad can use a bigger value
  ...
  attachInterrupt(1, int0IRCallback, FALLING);//IR connected to P3.2 (IRQ 0) // if P3.3 (IRQ 1)
